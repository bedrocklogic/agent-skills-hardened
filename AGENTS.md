...
Before changing a skill, read `SECURITY.md`, `UPSTREAM.md`, `MAINTENANCE.md`,
`MANIFEST.md`, and the complete target `SKILL.md`. Keep instructions concise,
scoped, and compatible with higher-priority user and repository rules. Do not add
executables, hooks, symlinks, submodules, installers, manifests, command aliases,
agent personas, or automatic network use.
